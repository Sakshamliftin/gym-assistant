  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-20 h-20 rounded-full bg-blue-600 text-white text-4xl shadow-lg cursor-pointer"
      >
        +
      </button>
      ...
      {open && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z">
          <div className="bg-black/50 p-6 rounded-xl w-96 h-96 border-white z-50">
            ...
            <button
              ...
              className="mt-2 text-sm text-white w-full cursor-pointer"
            >
              Cancel
            </button>
          </div>
